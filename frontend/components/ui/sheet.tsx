  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-sidebar text-sidebar-foreground shadow-xl transition ease-in-out",
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("font-semibold text-sidebar-foreground", className)}
      {...props}
    />
  );
}
